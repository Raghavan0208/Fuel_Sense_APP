...
namespace StarZero.API.Controllers;
...
public class BaseController<TIContract, TItem> : Controller
        ...
        where TItem : Invent.Helper.EntityBase
{
    private readonly TIContract contract;
    private readonly IOptionsSnapshot<StarZero.Helper.AppConfiguration> appConfiguration;

    public BaseController(TIContract iContract, IOptionsSnapshot<AppConfiguration> iAppConfiguration)
    {
    ...
    //        responseMessage = this..PostAsync(apiURL, restRequest.Content).Result;
