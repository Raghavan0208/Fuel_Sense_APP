namespace StarZero.UploadHelper;
...
public class S3ClientHelperService : IS3ClientHelperService
{
    ...
    public S3ClientHelperService(IOptionsSnapshot<AppConfiguration> _AppConfiguration)
    {
        awsRegion = _AppConfiguration.Value.AWSConfiguration.AWSRegion;
        environment = _AppConfiguration.Value.AWSConfiguration.Environment;
