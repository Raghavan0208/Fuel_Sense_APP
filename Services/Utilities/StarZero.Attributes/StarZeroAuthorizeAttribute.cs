...
{
    using StarZero.Attributes.Helpers;
    ...
    public class StarZeroAuthorizeAttribute : AuthorizeAttribute, IAuthorizationFilter, IOrderedFilter
    {
        private ROLES_ENUM[] rolesEnum;

        public StarZeroAuthorizeAttribute(params ROLES_ENUM[] userRoles)
        {
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            if (controllerActionDescriptor != null)
            {
                ...
                {
                    bool ignoreControllerAttribute = controllerActionDescriptor.MethodInfo.GetCustomAttributes(typeof(StarZeroAuthorizeAttribute), true)
                                                   .Any(item => item.GetType().Equals(typeof(StarZeroAuthorizeAttribute)));
