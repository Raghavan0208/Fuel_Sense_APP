...
public class PlansModelMapper : ITypeConverter<ViewEntities.Plans, DBO.Plans>
{
    public DBO.Plans Convert(ViewEntities.Plans source, DBO.Plans destination, ResolutionContext context)
    {
        var item = new DBO.Plans();
