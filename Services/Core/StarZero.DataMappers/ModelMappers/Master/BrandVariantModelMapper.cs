...
public class BrandVariantModelMapper : ITypeConverter<ViewEntities.BrandVariant, DBO.BrandVariant>
{
    public DBO.BrandVariant Convert(ViewEntities.BrandVariant source, DBO.BrandVariant destination, ResolutionContext context)
    {
        var item = new DBO.BrandVariant();
