...
public class AddressModelMapper : ITypeConverter<ViewEntities.Address, DBO.Address>
{
    public DBO.Address Convert(ViewEntities.Address source, DBO.Address destination, ResolutionContext context)
    {
        var item = new DBO.Address();
