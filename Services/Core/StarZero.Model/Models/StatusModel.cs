...
public class StatusModel : BaseModel<DBO.Status>, IStatusModel
    {
    ...
    public StatusModel(IOptionsSnapshot<AppConfiguration> iConfig, IMapper mapper, IPrincipal iPrincipal = null, CountryContext iContext = null) : base()
        {
            this.config = iConfig;
            this.mapper = mapper;
        ...
        public ViewEntities.Status Get(long id)
        {
        ...
        public IEnumerable<ViewEntities.Status> GetList()
        {
            var results = this.FindItems(item => item.Active == true);
            var mapperResults = this.mapper.Map<IEnumerable<DBO.Status>, IEnumerable<ViewEntities.Status>>(results);

            return mapperResults;
        }

        public long Post(ViewEntities.Status item)
        {
        ...
        public long Put(ViewEntities.Status item)
        {
            var mapperResult = this.mapper.Map<ViewEntities.Status, DBO.Status>(item);
        ...
        public long Post(ViewEntities.Status item, IFormFileCollection postedFileCollection)
        {
            var mapperResult = this.mapper.Map<ViewEntities.Status, DBO.Status>(item);
        ...
        public long Put(ViewEntities.Status item, IFormFileCollection postedFileCollection)
        {
            var mapperResult = this.mapper.Map<ViewEntities.Status, DBO.Status>(item);
